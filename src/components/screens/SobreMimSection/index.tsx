    ...
    <div className="ml-[5vw] flex flex-wrap items-center justify-center">
      <div className="z-10 max-w-6xl phone:mr-[3vw]">
        <div>
          ...
          <h2 className="mt-4 flex gap-2 text-8xl font-medium phone:text-2xl tablet:text-3xl desktops:text-7xl laptops:text-5xl">
            Olá, meu nome é
            <span>
              <h2>David</h2>
          ...
          <p className="mt-[2vh] text-2xl leading-relaxed tracking-wider phone:mt-[1vh] phone:text-base tablet:max-w-[80vw] tablet:text-xl tablet:tracking-normal desktops:max-w-[90vw] laptops:max-w-[80vw] ">
        ...
        <div className="mb-[5vh] mt-[5vh] flex gap-[4vh] phone:mt-[3vh] phone:flex-wrap phone:justify-center tablet:hidden details:hidden desktops:gap-[2vh] laptops:hidden">
